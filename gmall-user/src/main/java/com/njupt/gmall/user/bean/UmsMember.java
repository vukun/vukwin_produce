package com.njupt.gmall.user.bean;
...
/**
 * @author zhaokun
 * @create 2020-05-17 23:15
 *
 * @Id 用于标识声明主键的变量
 * @GeneratedValue 用于标注主键的生成策略，通过strategy 属性指定。
 * 默认情况下，JPA 自动选择一个最适合底层数据库的主键生成策略：SqlServer对应identity，MySQL对应 auto increment。
 *
 *  IDENTITY ：表示采用数据库ID自增长的方式来自增主键字段，Oracle不支持这个形式
 */
